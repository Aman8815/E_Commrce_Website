...
public class User {
	...
	@Column(length = 500, name = "user_email")
	private String userEmail;
	@Column(length = 500, name = "user_password")
	...
	public User(String userName, String userEmail, String userPassword, String userPic, String userAddress) {
		super();
		this.userName = userName;
		this.userEmail = userEmail;
		this.userPassword = userPassword;
	...
	public String toString() {
		return "User [userId=" + userId + ", userName=" + userName + ", userEmail=" + userEmail + ", userPassword="
				+ userPassword + ", userPic=" + userPic + ", userAddress=" + userAddress + "]";
	}
